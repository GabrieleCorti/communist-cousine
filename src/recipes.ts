...
export const recipes: Dish[] = [
  {
    ...
    steps: [
      ...
      "Tosatare le cipolla con burro e olio",
      ...
      "Sobbollite il tutto per circa un'ora e mezza con coperchio",
      "Per quanto riguarda il cotechino, seguire le indicazioni di cottura",
      "Aggiungere il cotechino alle lenticchi poco prima di servire il piatto",
    ],
  },
  {
    ...
    steps: [
      ...
      "Conservare l'acqua di cottura della pasta perchè potrebbe venire utile più avanti nella ricetta",
      "Risottare la pasta per 3 o 4 minuti aggiungendo acqua di cottura se necessario",
      "Unire dell'acqua di cottura al pecorino grattuggiato fino a che non si forma una crema con la consistenza che più vi soddisfa",
      ...
      "Se la cremma appare troppo densa aggiungere dell'acqua di cottura",
    ],
  },
  {
    ...
    author: "Gabriele Corti",
    description:
      "Pasta con pomodiri secchi e olive tipica della tradizione Siciliana senza ingediente di origine animale",
    servings: 4,
    ingredients: [
      { name: "Pasta", quantity: 400, unit: "g" },
      { name: "Pepe", quantity: 40, unit: "grani" },
    ...
    steps: [
      ...
      "Quando la cipolla è translucida, togliere i gambi di prezzemolo e aggiungere le olive",
      "Dopo qualche minuto aggiungere i capperi ben sciacquati e lasciare stufare il tutto",
      "Tritare i pomidiori secchi e le cime i prezzemolo della dimensione desiderata",
      "A cottura ultimata scolare la pasta e unira con olive e capeeri e il trito di pomodori secchi e prezzemolo",
    ],
  },
  {
    ...
    steps: [
      "Mischiare molto bene acqua e farina e lasciare riposare alemno 8h",
      "Terminate le 8h togliere la schiuma che eventualmente si è formata in superfice",
      "Aggiungere un po meno della metà di olio al composto e mischiare molto bene",
      "Ungere la teglia con la restatnte parte di olio e aggiungere il composto",
      "Mischiare il composto nella teglia con una forchetta e informare a 250 gradi, i primi 10 minuti appogiando la teglia sul fondo del forno, mentre i restante 10 a metà altezza",
      "A 5 minuti dalla fine della cottura aggiungere il rosmarino",
      "Prima di mangiare la farinata lasciarla intiepidire",
    ],
    note: [
      "Queste quantità sono per una teglia da 12, perciò non seguire il calcolo a persona ma calcolare i multipi di teglia",
    ],
  },
];
